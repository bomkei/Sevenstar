...
MenuEntry::MenuEntry(int radioId, const std::string &name,
                     FuncPointer func, const std::string &note)
  : Hotkeys(this),
    _item(new MenuEntryImpl(name, func, note, this))
{
...
MenuEntry *MenuEntry::GetEnabled()
{
  this->Enable();
  return this;
}

bool MenuEntry::AssignEnabledFlag(bool &flag)
{
