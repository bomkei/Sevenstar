...
void Keyboard::Populate(const std::vector<CustomIcon> &input,
                        bool resetScroll)
{
  _keyboard->Populate(input, resetScroll);
  _isPopulated = true;
...
int Keyboard::Open(u8 &output) const
{
  ...
  _keyboard->SetLayout(_hexadecimal ? Layout::HEXADECIMAL
                                    : Layout::DECIMAL);
  if (_hexadecimal) {
  ...
  if (ret >= 0) {
    ...
    output = *(static_cast<u8 *>(
      ConvertToU8(input, _keyboard->IsHexadecimal())));
  }
  return (ret);
}
...
int Keyboard::Open(u16 &output) const
{
  ...
  if (ret >= 0) {
    std::string &input = _keyboard->GetInput();
    output = *(static_cast<u16 *>(
      ConvertToU16(input, _keyboard->IsHexadecimal())));
  }
  return (ret);
}
...
int Keyboard::Open(u32 &output) const
{
  ...
  if (ret >= 0) {
    std::string &input = _keyboard->GetInput();
    output = *(static_cast<u32 *>(
      ConvertToU32(input, _keyboard->IsHexadecimal())));
  }
  return (ret);
}
...
int Keyboard::Open(u64 &output) const
{
  ...
  if (ret >= 0) {
    std::string &input = _keyboard->GetInput();
    output = *(static_cast<u64 *>(
      ConvertToU64(input, _keyboard->IsHexadecimal())));
  }
  return (ret);
}
...
int Keyboard::Open(float &output) const
{
  ...
  if (ret >= 0) {
    ...
    output = *(static_cast<float *>(
      ConvertToFloat(input, _keyboard->IsHexadecimal())));
  }
  return (ret);
}
